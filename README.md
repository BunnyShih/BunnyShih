...
**AI Integration Engineer** — bridging legacy enterprise systems with modern AI, with a focus on security and measurable productivity gains.

---

## 🔧 What I Do

I work at the intersection of three things most companies need but rarely find in one person:

- **🗄️ Legacy Data to AI** — connecting systems like Oracle to LLM pipelines
- **🔒 AI Security & Sandbox** — defending AI systems against prompt injection, jailbreaks, and data leakage
- **⚡ AI-Driven Productivity** — automating manual workflows into pipelines that run in seconds
...
`Python` · `Oracle DB` · `Claude API` · `REST APIs` · `Git`
